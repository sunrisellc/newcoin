...
"""Verify that starting newcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start newcoin with -h for help text")
        ...
        self.log.info("Start newcoin with -version for version information")
        ...
        self.log.info("Start newcoind with -fakearg to make sure it does not start")
