...
1. Clone the Newcoin Core source code:
...
2.  Build Newcoin Core:
    ...
    Configure and build the headless Newcoin Core binaries as well as the GUI (if Qt is found).
...
Newcoin Core is now available at `./src/newcoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/Newcoin"

    touch "/Users/${USER}/Library/Application Support/Newcoin/newcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Newcoin/newcoin.conf"

The first time you run newcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
