# Support for Output Descriptors in Newcoin Core

Since Newcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Newcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Newcoin Core wallets, a convenience function `combo` is
